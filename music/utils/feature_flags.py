...
class FeatureFlags:
    ...
    @classmethod
    def enable_phase_1(cls):
        """Enable all Phase 1 features (content-based filtering)."""
        cls.set_flag("content_based_filtering", True)
        cls.set_flag("similarity_caching", True)
        logger.info("Phase 1 features enabled")
    
    @classmethod
    def enable_phase_2(cls):
        """Enable all Phase 2 features (hybrid recommendations)."""
        cls.enable_phase_1()  # Phase 2 depends on Phase 1
    ...
    @classmethod
    def enable_phase_3(cls):
        """Enable all Phase 3 features (deep-cut discovery)."""
        cls.enable_phase_2()  # Phase 3 depends on Phase 2
