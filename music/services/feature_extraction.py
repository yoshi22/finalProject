...
from music.lastfm import get_track_info, get_artist_info
...
class FeatureExtractor:
    ...
    def fetch_tags_for_track(track: Track) -> tuple:
        ...
        try:
            ...
            track_info = get_track_info(track.name, track.artist.name)
            ...
            artist_info = get_artist_info(track.artist.name)
